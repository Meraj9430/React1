...
const Profile = () => {
  ...
  const v= localStorage.getItem('doctorId')
  ...
  const deta=async()=>{
    const res = await fetch(`${API}/api/doctor/getDoctorById/${v}`) 
    try {
  ...
  const setuserdeta=()=>{
    ...
    setHouse_street_no(doctor.house_street_no);
    setColony_locality(doctor.colony_locality);
    setCity(doctor.city)
    setState(doctor.state)
    setCountry(doctor.country)
    setPincode(doctor.pincode)
    setFee(doctor.fee);
    setday({arr:[doctor.day]});
    ...
    <>
      {loader ? (
        ...
        <div className="Doc_reg_form">
          <div style={{marginTop:'1rem',display:'flex',width:'100%',alignItems:'center',justifyContent:'center'}}>
            <div style={{borderRadius:'100%',overflow:'hidden', width:'100px',height:'100px'}}>
              {/* <span>Doctor Registration form</span> */}
              
              <img style={{width:'100%',height:'100%'}} src={tog?Photo:doctor.photo} alt="Img" />
            </div>
          </div>
          <form id="DRP_form" onSubmit={submitForm}>
            {/* <div id="DRP_line"></div> */}
            <div>
              <h1>Profile</h1><img src="" alt="" />
              <div className="DRP_form_deta">
                ...
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <input
                      value={tog?mobile:doctor.mobile}
                ...
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <input
                      type="text"
                      value={tog?pass:doctor.password}
                ...
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <input
                      id=""
                      type="text"
                      value={tog?qualification:doctor.qualification}
                ...
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <select
                      value={tog?specialization:doctor.specialization}
                ...
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <input
                      id="name"
                      type="text"
                      value={tog?experience:doctor.experience}
                ...
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <select
                      value={tog?gender:doctor.gender}
              ...
              <div className="DRP_form_deta">
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <input
                      id=""
                      value={tog?house_street_no:doctor.house_street_no}
                ...
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <input
                      id=""
                      value={tog?colony_locality:doctor.colony_locality}
                ...
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <select
                      value={tog?country:doctor.country}
                ...
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <input
                      value={tog?pincode:doctor.pincode}
            ...
            <div>
              ...
              <div className="DRP_form_deta">
                ...
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <select
                      value={tog?startTime:doctor.startTime}
                ...
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <select
                      value={tog?endTime:doctor.endTime}
                ...
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <select
                      value={tog?interval:doctor.interval}
            ...
            <div>
              ...
              <div className="DRP_form_deta">
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <input
                      id="name"
                      type="text"
                      value={tog?extra_mobile:doctor.extra_mobile}
                ...
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <select
                      value={tog?languages:doctor.languages}
                ...
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <select
                      value={tog?physical_info:doctor.physical_info}
                ...
                <div className="Doc_box">
                  ...
                  <div className="Doc_input_box">
                    <select
                      value={tog?virtual:doctor.virtual}
            ...
            <div id="DRP_line"></div>
            {tog ?<div id="DRP_btn">
              <button className="DRP_submit_btn" type="submit"onClick={()=>setTog(false)}>
                <span>Update</span>
              </button>
            </div>:
            <div id="DRP_btn">
              <button className="DRP_submit_btn" onClick={()=>setTog(true)}>
                <span>Edit</span>
              </button>
            </div>
            }
